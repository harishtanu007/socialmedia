...
class Login extends Component {
    constructor(props) {
        ...
        localloginComponent.push( <
            MuiThemeProvider key = {
                "theme"
            } >
            <
            div >
            <
            TextField hintText = "Enter your College Rollno"
    ...
    handleClick(event) {
        ...
        axios.post(apiBaseUrl + 'login', payload)
            .then(function (response) {
                    ...
                    if (response.data.code == 200) {
                        ...
                        var uploadScreen = [];
                        uploadScreen.push( < UploadPage appContext = {
                                self.props.appContext
                            }
                            role = {
                                self.state.loginRole
                            }
                            />)
        ...
        render() {
            return ( <
                    ...
                    onChange = {
                        (event, index, value) => this.handleMenuChange(value)
                    } >
                    <
                    MenuItem value = {
                        1
